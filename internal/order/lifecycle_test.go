...
func TestShouldApplyOperatorTransition(main *testing.T) {
	cases := []struct {
		...
		{"PaidToRefundRequested", "paid", "refund_requested", true},
		{"ProcessingToShipped", "processing", "shipped", true},
		{"ProcessingToRefunded", "processing", "refunded", true},
		{"ProcessingToRefundRequested", "processing", "refund_requested", true},
		...
		{"RefundRequestedToProcessing", "refund_requested", "processing", true},
		{"RefundRequestedToShipped", "refund_requested", "shipped", true},
		{"RefundRequestedToDelivered", "refund_requested", "delivered", true},
